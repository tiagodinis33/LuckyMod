...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i51_1_, int p_i51_2_, int p_i51_3_, int[] p_i51_4_, boolean p_i51_5_)
    {
        this.iconName = p_i51_1_;
        this.width = p_i51_2_;
        this.height = p_i51_3_;
        this.data = p_i51_4_;
        this.direct = p_i51_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i51_2_, p_i51_3_, p_i51_1_);
        this.mipmapDatas = generateMipMapData(p_i51_4_, p_i51_2_, p_i51_3_, this.mipmapDimensions);
