...
public class CompactArrayList
{
    ...
    public CompactArrayList(int p_i21_1_)
    {
        this(p_i21_1_, 0.75F);
    }

    public CompactArrayList(int p_i22_1_, float p_i22_2_)
    {
        this.list = null;
        this.initialCapacity = 0;
        this.loadFactor = 1.0F;
        this.countValid = 0;
        this.list = new ArrayList(p_i22_1_);
        this.initialCapacity = p_i22_1_;
        this.loadFactor = p_i22_2_;
    }
