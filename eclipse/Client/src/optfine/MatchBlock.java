...
public class MatchBlock
{
    ...
    public MatchBlock(int p_i48_1_)
    {
        this.blockId = p_i48_1_;
    }

    public MatchBlock(int p_i49_1_, int p_i49_2_)
    {
        this.blockId = p_i49_1_;

        if (p_i49_2_ >= 0 && p_i49_2_ <= 15)
        {
            this.metadatas = new int[] {p_i49_2_};
        }
    }

    public MatchBlock(int p_i50_1_, int[] p_i50_2_)
    {
        this.blockId = p_i50_1_;
        this.metadatas = p_i50_2_;
    }
