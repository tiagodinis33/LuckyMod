...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(String p_i40_1_, int p_i40_2_)
    {
        this(p_i40_1_, p_i40_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i41_1_, int p_i41_2_, Proxy p_i41_3_)
    {
        this.host = null;
        this.port = 0;
