...
public class Reflector
{
    ...
    public static ReflectorMethod ForgeHooksClient_applyTransform = new ReflectorMethod(ForgeHooksClient, "applyTransform", new Class[] {net.minecraft.client.renderer.Matrix4f.class, Optional.class});
    ...
    public static ReflectorClass ForgeBiomeGenBase = new ReflectorClass(Biome.class);
