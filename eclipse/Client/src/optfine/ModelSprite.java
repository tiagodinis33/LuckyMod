...
public class ModelSprite
{
    ...
    public ModelSprite(ModelRenderer p_i52_1_, int p_i52_2_, int p_i52_3_, float p_i52_4_, float p_i52_5_, float p_i52_6_, int p_i52_7_, int p_i52_8_, int p_i52_9_, float p_i52_10_)
    {
        this.modelRenderer = p_i52_1_;
        this.textureOffsetX = p_i52_2_;
        this.textureOffsetY = p_i52_3_;
        this.posX = p_i52_4_;
        this.posY = p_i52_5_;
        this.posZ = p_i52_6_;
        this.sizeX = p_i52_7_;
        this.sizeY = p_i52_8_;
        this.sizeZ = p_i52_9_;
        this.sizeAdd = p_i52_10_;
        this.minU = (float)p_i52_2_ / p_i52_1_.textureWidth;
        this.minV = (float)p_i52_3_ / p_i52_1_.textureHeight;
        this.maxU = (float)(p_i52_2_ + p_i52_7_) / p_i52_1_.textureWidth;
        this.maxV = (float)(p_i52_3_ + p_i52_8_) / p_i52_1_.textureHeight;
    }
