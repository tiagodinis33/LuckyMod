...
public class FileUploadThread extends Thread
{
    ...
    public FileUploadThread(String p_i30_1_, Map p_i30_2_, byte[] p_i30_3_, IFileUploadListener p_i30_4_)
    {
        this.urlString = p_i30_1_;
        this.headers = p_i30_2_;
        this.content = p_i30_3_;
        this.listener = p_i30_4_;
    }
