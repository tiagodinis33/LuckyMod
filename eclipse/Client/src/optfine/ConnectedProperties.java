...
public class ConnectedProperties
{
    ...
    public ConnectedProperties(Properties p_i24_1_, String p_i24_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("ConnectedTextures");
        this.name = connectedparser.parseName(p_i24_2_);
        this.basePath = connectedparser.parseBasePath(p_i24_2_);
        this.matchBlocks = connectedparser.parseMatchBlocks(p_i24_1_.getProperty("matchBlocks"));
        this.metadatas = connectedparser.parseIntList(p_i24_1_.getProperty("metadata"));
        this.matchTiles = this.parseMatchTiles(p_i24_1_.getProperty("matchTiles"));
        this.method = parseMethod(p_i24_1_.getProperty("method"));
        this.tiles = this.parseTileNames(p_i24_1_.getProperty("tiles"));
        this.connect = parseConnect(p_i24_1_.getProperty("connect"));
        this.faces = parseFaces(p_i24_1_.getProperty("faces"));
        this.biomes = connectedparser.parseBiomes(p_i24_1_.getProperty("biomes"));
        this.minHeight = connectedparser.parseInt(p_i24_1_.getProperty("minHeight"), -1);
        this.maxHeight = connectedparser.parseInt(p_i24_1_.getProperty("maxHeight"), 1024);
        this.renderPass = connectedparser.parseInt(p_i24_1_.getProperty("renderPass"));
        this.innerSeams = ConnectedParser.parseBoolean(p_i24_1_.getProperty("innerSeams"));
        this.width = connectedparser.parseInt(p_i24_1_.getProperty("width"));
        this.height = connectedparser.parseInt(p_i24_1_.getProperty("height"));
        this.weights = connectedparser.parseIntList(p_i24_1_.getProperty("weights"));
        this.symmetry = parseSymmetry(p_i24_1_.getProperty("symmetry"));
    }
