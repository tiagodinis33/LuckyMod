...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public boolean freeCamIsEnabled;
    /** Torch flicker X */
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate((mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.x:entity.prevRotationYaw) + ((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x : entity.rotationYaw) - (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.x:entity.prevRotationYaw)) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate((mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.y:entity.prevRotationPitch) + ((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.y : entity.rotationPitch) - (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.y:entity.prevRotationPitch)) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x : entity.rotationYaw;
                float f2 = mc.entityRenderer.freeCamIsEnabled? freeCamRotation.y : entity.rotationPitch;
                ...
                GlStateManager.rotate((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.y : entity.rotationPitch) - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x : entity.rotationYaw) - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - (mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x : entity.rotationYaw), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - (mc.entityRenderer.freeCamIsEnabled? freeCamRotation.y : entity.rotationPitch), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.x:entity.prevRotationYaw) + ((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x:entity.rotationYaw) - (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.x:entity.prevRotationYaw)) * partialTicks + 180.0F;
                float f7 = (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.y:entity.prevRotationPitch) + ((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.y : entity.rotationPitch) - (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.y:entity.prevRotationPitch)) * partialTicks;
                float f8 = 0.0F;
        ...
        else if (!this.mc.gameSettings.debugCamEnable)
        {
            ...
            {
                GlStateManager.rotate((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x:entity.rotationYaw) + ((mc.entityRenderer.freeCamIsEnabled? freeCamRotation.x:entity.rotationYaw) - (mc.entityRenderer.freeCamIsEnabled? prevFreeCamRotation.x:entity.prevRotationYaw)) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
            }
        }
    ...
    public static Vector2f freeCamRotation = new Vector2f(0f,0f);
    public static Vector2f prevFreeCamRotation = new Vector2f(0f,0f);
    public static void setAngles(float yaw, float pitch)
    {
        float f =          freeCamRotation.y;
        float f1 =         freeCamRotation.x;
        freeCamRotation.x = (float)((double)freeCamRotation.x + (double)yaw * 0.15D);
        freeCamRotation.y = (float)((double)freeCamRotation.y - (double)pitch * 0.15D);
        freeCamRotation.y = MathHelper.clamp_float(        freeCamRotation.y, -90.0F, 90.0F);
        prevFreeCamRotation.y += freeCamRotation.y - f;
        prevFreeCamRotation.x += freeCamRotation.x - f1;
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (this.mc.inGameHasFocus && flag)
        {
            ...
            if (this.mc.gameSettings.smoothCamera)
            {
                ...
                if(!mc.entityRenderer.freeCamIsEnabled)
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    ...
                    {
                        this.mc.currentScreen.onRender(k1, l1, partialTicks);
                    }
                }
