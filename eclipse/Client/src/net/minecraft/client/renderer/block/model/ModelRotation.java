...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public net.minecraft.client.renderer.Matrix4f getMatrix()
    {
        return (net.minecraft.client.renderer.Matrix4f) (Reflector.ForgeHooksClient_getMatrix.exists() ? (Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new Matrix4f(this.getMatrix4d()));
    }
