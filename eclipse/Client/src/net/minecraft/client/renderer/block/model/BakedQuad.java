...
public class BakedQuad implements IVertexProducer
{
    ...
    public BakedQuad(int[] p_i7_1_, int p_i7_2_, EnumFacing p_i7_3_, TextureAtlasSprite p_i7_4_, boolean p_i7_5_, VertexFormat p_i7_6_)
    {
        this.vertexData = p_i7_1_;
        this.tintIndex = p_i7_2_;
        this.face = p_i7_3_;
        this.sprite = p_i7_4_;
        this.applyDiffuseLighting = p_i7_5_;
        this.format = p_i7_6_;
        this.fixVertexData();
    }
