            ...
            if (this.canRenderName(entity))
            {
                ...
                if (d0 < (double)(f * f))
                {
                    ...
                    if(entity instanceof EntityPlayer) {
                    	this.renderEntityName(entity, x, y+0.2, z, s, d0);
                        this.renderEntityName(entity, x, y, z, "§c§l♥§r "+MathUtils.round(new Double(entity.getHealth()), 0), d0);
