...
public class RenderChunk
{
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator)
    {
        ...
        if (this.world != null)
        {
            ...
            if (!chunkcacheof.extendedLevelsInChunkCache())
            {
                ++renderChunksUpdated;
    ...
    private ChunkCacheOF makeChunkCacheOF()
    {
        ...
        IBlockAccess iblockaccess = this.createRegionRenderCache(this.world, blockpos, this.position.add(16, 16, 16), 1);

        if (Reflector.MinecraftForgeClient_onRebuildChunk.exists())
        {
            Reflector.call(Reflector.MinecraftForgeClient_onRebuildChunk, new Object[] {this.world, this.position, iblockaccess});
        }

        ChunkCacheOF chunkcacheof = new ChunkCacheOF(iblockaccess, blockpos, 1);
        return chunkcacheof;
    }
