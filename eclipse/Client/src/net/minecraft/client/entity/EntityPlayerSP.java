...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            super.onUpdate();
            if(mc.gameSettings.getLuckyModGson().get("toggleSprint").getAsBoolean()) {
    ...
    public void onLivingUpdate()
    {
        ...
        {
            if (this.sprintToggleTimer <= 0 && !sprint)
            {
        ...
        if (/*!this.isSprinting() &&*/ this.movementInput.moveForward >= 0.8F && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS) /*&& sprint*/)
        {
        	if(mc.gameSettings.getLuckyOptionB("toggleSprint"))
        		setSprinting(sprint);
        	else
        		if(sprint)
        			setSprinting(true);
