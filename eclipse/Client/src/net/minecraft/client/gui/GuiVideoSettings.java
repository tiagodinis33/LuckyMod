...
public class GuiVideoSettings extends GuiScreen
{
    ...
    private static GameSettings.Options[] VIDEO_OPTIONS = new GameSettings.Options[] {GameSettings.Options.GRAPHICS, GameSettings.Options.RENDER_DISTANCE, GameSettings.Options.AMBIENT_OCCLUSION, GameSettings.Options.FRAMERATE_LIMIT, GameSettings.Options.AO_LEVEL, GameSettings.Options.VIEW_BOBBING, GameSettings.Options.GUI_SCALE, GameSettings.Options.USE_VBO, GameSettings.Options.GAMMA, GameSettings.Options.ATTACK_INDICATOR, GameSettings.Options.FOG_FANCY, GameSettings.Options.FOG_START};
    ...
    public void initGui()
    {
        ...
        {
            GameSettings.Options gamesettings$options = VIDEO_OPTIONS[i];
        ...
        int l = this.height / 6 + 21 * (VIDEO_OPTIONS.length / 2) - 12;
        int i1 = 0;
