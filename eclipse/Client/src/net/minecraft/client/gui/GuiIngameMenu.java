...
import org.luckymod.guis.LuckyModInfoGUI;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        int i = -16;
        int j = 98;
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + -16, I18n.format(this.mc.isIntegratedServerRunning()?"menu.returnToMenu":"menu.disconnect", new Object[0])));
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 - 100, this.height / 4 + 55, "LuckyMod Info"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 7:
                ...
                break;
            case 8:
            	mc.displayGuiScreen(new LuckyModInfoGUI(this));
            	break;
        }
    }
