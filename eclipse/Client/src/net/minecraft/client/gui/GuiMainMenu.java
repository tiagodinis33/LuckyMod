...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.realmsButton = this.func_189646_b(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2,
	...
	private void addDemoButtons(int p_73972_1_, int p_73972_2_) {
		...
		this.buttonResetDemo = this.func_189646_b(new GuiButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1,
	...
	private void rotateAndBlurSkybox(float partialTicks) {
		...
		for (int j = 0; j < 3; ++j) {
			...
			vertexbuffer.pos((double) k, (double) l, (double) this.zLevel).tex((double) (0.0F + f1), 1.0D)
					.color(1.0F, 1.0F, 1.0F, f).endVertex();
			vertexbuffer.pos((double) k, 0.0D, (double) this.zLevel).tex((double) (1.0F + f1), 1.0D)
					.color(1.0F, 1.0F, 1.0F, f).endVertex();
			vertexbuffer.pos(0.0D, 0.0D, (double) this.zLevel).tex((double) (1.0F + f1), 0.0D)
					.color(1.0F, 1.0F, 1.0F, f).endVertex();
			vertexbuffer.pos(0.0D, (double) l, (double) this.zLevel).tex((double) (0.0F + f1), 0.0D)
					.color(1.0F, 1.0F, 1.0F, f).endVertex();
		}
	...
	private void renderSkybox(int mouseX, int mouseY, float partialTicks) {
		...
		VertexBuffer vertexbuffer = tessellator.getBuffer();
		vertexbuffer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		vertexbuffer.pos(0.0D, (double) j, (double) this.zLevel).tex((double) (0.5F - f1), (double) (0.5F + f2))
				.color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
		vertexbuffer.pos((double) i, (double) j, (double) this.zLevel).tex((double) (0.5F - f1), (double) (0.5F - f2))
				.color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
		vertexbuffer.pos((double) i, 0.0D, (double) this.zLevel).tex((double) (0.5F + f1), (double) (0.5F - f2))
				.color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, (double) this.zLevel).tex((double) (0.5F + f1), (double) (0.5F + f2))
				.color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
		tessellator.draw();
	}
	...
	public void onRender(int mouseX, int mouseY, float partialTicks) {
		if (mc.gameSettings.getLuckyModGson().get("enablePanorama").getAsBoolean()) {
			GlStateManager.disableAlpha();
			this.renderSkybox(mouseX, mouseY, partialTicks);
			GlStateManager.enableAlpha();
			}else {
				drawRect(0, 0, width, height, java.awt.Color.BLUE.getRGB());
			}
			int i = 274;
			...
			float f = 1.8F - MathHelper
					.abs(MathHelper.sin((float) (Minecraft.getSystemTime() % 1000L) / 1000.0F * ((float) Math.PI * 2F))
							* 0.1F);
		...
		String s = "LuckyMod "+ Constants.VERSION +" with Minecraft 1.10";
		

		this.drawString(this.fontRendererObj, s, 2, this.height - 10, -1);
		String s1 = "Copyright LuckyMod.";
		this.drawString(this.fontRendererObj, "Copyright LuckyMod.",
				this.width - this.fontRendererObj.getStringWidth("Copyright LuckyMod.") - 2,
				this.height - 1 * fontRendererObj.FONT_HEIGHT, -1);
		String s2 = "Este programa é livre de ser distribuido em quaisquer condições!";
		this.drawString(this.fontRendererObj, s2,
				this.width - this.fontRendererObj.getStringWidth(s2) - 2,
				this.height - 2*fontRendererObj.FONT_HEIGHT, -1);
		...
		if (this.areRealmsNotificationsEnabled()) {
			this.realmsNotification.onRender(mouseX, mouseY, partialTicks);
		}
	}
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		...
		synchronized (this.threadLock) {
			if (!this.openGLWarning1.isEmpty() && mouseX >= this.openGLWarningX1 && mouseX <= this.openGLWarningX2
