...
import org.luckymod.guis.LuckyModOptions;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(new GuiButton(201, this.width / 2 - 100, this.height / 6 + 140, "Configuração do LuckyMod"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if(button.id == 201) {
                this.mc.gameSettings.saveOptions();
                mc.displayGuiScreen(new LuckyModOptions(this, settings));
            }
        }
    }
